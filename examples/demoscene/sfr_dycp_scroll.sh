...
export TEXT="             Hey! This is probably the very first DYCP-Scroller for Linux. ;) Greetings!"

TMPDIR=/tmp/gtk3dialog/examples/"`basename $0`"/dycp
mkdir -p $TMPDIR
trap 'rm -rf $TMPDIR' EXIT

export PIC=$TMPDIR/pic.svg
export SINUS=$TMPDIR/sinus_table
export X_POS=$TMPDIR/dycp_x
export TEXT_POS=$TMPDIR/text_position
echo 0 > $X_POS
echo 0 > $TEXT_POS
